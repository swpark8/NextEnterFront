            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className={`px-4 py-1.5 text-sm font-bold rounded-full ${getStatusColor(job.status)}`}>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 font-semibold text-white transition rounded-xl shadow-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800"
                >
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-6 transition bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-xl hover:shadow-md">
                <div className="flex items-center justify-between mb-2">
                  <div className="text-sm font-medium text-blue-700">조회수</div>
                  <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                  </svg>
                </div>
                <div className="text-3xl font-bold text-blue-700">{job.viewCount}</div>
              </div>
              <button
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="text-sm font-medium text-purple-700">지원자 클릭 시 목록보기</div>
                  <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <div className="text-3xl font-bold text-purple-700">{job.applicantCount}</div>
              </button>
              <div className="p-6 transition bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-xl hover:shadow-md">
                <div className="flex items-center justify-between mb-2">
                  <div className="text-sm font-medium text-orange-700">북마크</div>
                  <svg className="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                  </svg>
                </div>
                <div className="text-3xl font-bold text-orange-700">{job.bookmarkCount}</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 mb-6 bg-white shadow-md rounded-3xl">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-start gap-4 p-4 transition bg-gray-50 rounded-xl hover:bg-gray-100">
                ...
                <div className="flex-1">
                  <div className="mb-1 text-sm font-medium text-gray-500">회사명</div>
                  <div className="text-lg font-semibold text-gray-900">{job.companyName}</div>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 transition bg-gray-50 rounded-xl hover:bg-gray-100">
                <div className="p-2 bg-white rounded-lg shadow-sm">
                ...
                <div className="flex-1">
                  <div className="mb-1 text-sm font-medium text-gray-500">직무</div>
                  <div className="text-lg font-semibold text-gray-900">{job.jobCategory}</div>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 transition bg-gray-50 rounded-xl hover:bg-gray-100">
                <div className="p-2 bg-white rounded-lg shadow-sm">
                ...
                <div className="flex-1">
                  <div className="mb-1 text-sm font-medium text-gray-500">근무지</div>
              ...
              <div className="flex items-start gap-4 p-4 transition bg-gray-50 rounded-xl hover:bg-gray-100">
                ...
                <div className="flex-1">
                  <div className="mb-1 text-sm font-medium text-gray-500">경력</div>
              ...
              <div className="flex items-start gap-4 p-4 transition bg-gray-50 rounded-xl hover:bg-gray-100">
                ...
                <div className="flex-1">
                  <div className="mb-1 text-sm font-medium text-gray-500">급여</div>
                  <div className="text-lg font-semibold text-gray-900">
              ...
              <div className="flex items-start gap-4 p-4 transition bg-gray-50 rounded-xl hover:bg-gray-100">
                ...
                <div className="flex-1">
                  <div className="mb-1 text-sm font-medium text-gray-500">등록일 / 마감일</div>
                  <div className="text-lg font-semibold text-gray-900">
          ...
          {job.requiredSkills && (
            <div className="p-8 mb-6 bg-white shadow-md rounded-3xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="px-3 py-1 text-sm font-semibold text-red-700 bg-red-100 rounded-full">Required</span>
              </div>
          ...
          {job.preferredSkills && (
            <div className="p-8 bg-white shadow-md rounded-3xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="px-3 py-1 text-sm font-semibold text-green-700 bg-green-100 rounded-full">Preferred</span>
              </div>
